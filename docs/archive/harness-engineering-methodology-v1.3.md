> ⚠️ **已归档 — 请勿再更新或引用**
>
> 本文件为 v1.3 历史版本，已于 2026-04-15 归档。现行方法论请参考 `docs/context/harness-engineering-methodology-v2.0.md`。
> 保留本文件仅用于追溯早期决策背景（如"v1.4 内嵌说明""第一阶段 / 第二阶段"等旧概念）。

# Harness Engineering 全自动开发工作流：完整方法论
## v1.3 | 2026-04-10 [ARCHIVED]
